...
#
# Write a function named `simple_interest` that takes principal, 
# rate of interest (as a percentage), and time (years).
...
#
# Write a function named `apply_discount` that takes a product's 
# price and a discount percentage (from 0 to 100).
...
# Exercise 5: Sum to N
#
# Write a function named `sum_to` that takes a single integer n and 
...
#
# Create a function called `calculate_tip`. It should take the bill amount 
# and the tip percentage (as a whole number).
...
# where the order of numbers is important, 
# treat the first parameter as the first operand and the second 
# parameter as the second operand.
#
# Examples:
